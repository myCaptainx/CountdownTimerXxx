...
TELETIPS_MAIN_MENU_BUTTONS = [
            ...
            [
                ...
                InlineKeyboardButton('📣 CHANNEL', url='https://t.me/rolexverseupdates'),
...
async def callback_query(client: Client, query: CallbackQuery):
    if query.data=="HELP_CALLBACK":
        ...
        TELETIPS_GROUP_BUTTONS = [
            [
                InlineKeyboardButton("Versers Group chat [69]", url="https://t.me/Versers1008")
            ],
            [
                InlineKeyboardButton("⬅️ BACK", callback_data="START_CALLBACK"),
            ]
        ...
        TELETIPS_TUTORIAL_BUTTONS = [
            [
                InlineKeyboardButton("timepass Video", url="https://youtube.com/@iNCREDiBLEx69")
            ],
            [
                InlineKeyboardButton("⬅️ BACK", callback_data="START_CALLBACK"),
            ]
        ...
        TELETIPS_START_BUTTONS = [
            ...
            [
                InlineKeyboardButton('👥 SUPPORT', callback_data="GROUP_CALLBACK"),
                InlineKeyboardButton('📣 CHANNEL', url='https://t.me/Versers1008'),
                InlineKeyboardButton('👨‍💻 CREATOR', url='https://t.me/my_CaptainX')
            ],
            [
        ...
        if message.chat.id>0:
            ...
            if 0<user_input_time<=10:
                while user_input_time and not stoptimer:
                    ...
                    user_input_time -=1
                await finish_countdown.edit("🚨 huehue! Beep!! **TIME'S UP!!!**")
...
async def stop_timer(Client, message):
    ...
    try:
        if (await bot.get_chat_member(message.chat.id,message.from_user.id)).privileges:
            ...
            await message.reply('👮🏻‍♂️ Sorry cutie, **only admins** can execute this command.')
    except FloodWait as e:
        await asyncio.sleep(e.value)
